        ...
        <div className="details-page__card__list">
          <div className="details-page__card">
            {data?.first_name && (
              <div className="details-page__item">
                ...
                <span className="details-page__value">{data?.first_name}</span>
              </div>
            )}
          ...
          <div className="details-page__card">
            ...
            {data?.work_phone_number && (
              <div className="details-page__item">
                <span className="details-page__title">Work Phone Number:</span>
                <span className="details-page__value">
                  {data?.work_phone_number}
                </span>
              </div>
            ...
            {data?.home_phone_number && (
              <div className="details-page__item">
                <span className="details-page__title">Home Phone Number:</span>
                <span className="details-page__value">
                  {data?.home_phone_number}
                </span>
              </div>
